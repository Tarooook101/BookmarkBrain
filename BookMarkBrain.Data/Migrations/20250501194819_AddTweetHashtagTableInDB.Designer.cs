...
namespace BookMarkBrain.Data.Migrations
{
    ...
    [Migration("20250501194819_AddTweetHashtagTableInDB")]
    partial class AddTweetHashtagTableInDB
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BookMarkBrain.Core.Entities.TweetHashtag", b =>
                {
                    ...
                    b.HasOne("BookMarkBrain.Core.Entities.Hashtag", null)
                    ...
                    b.HasOne("BookMarkBrain.Core.Entities.Tweet", null)
                        .WithMany("TweetHashtags")
